...
<body>
	<div class="container mt-5">
		...
		<c:choose>
		<%-- ********************************** If the database contains persons ************************************* --%>
			<c:when test="${allPersons.isEmpty() == false}"> 
		...
		--%>			
			...
			<%-- If there are no persons in the database --%>
			<c:otherwise>
	            <p class="text-danger">Please add a person before creating a license.</p>
	            <a href="/persons/new" class="btn btn-primary">Add Person</a>
	        </c:otherwise>
		</c:choose>
	</div>
